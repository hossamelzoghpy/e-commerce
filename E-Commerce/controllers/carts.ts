...
import { CartItems, Carts } from '../interfaces/carts';
...
2- check if user have cart
    - if user don't have cart create one
    - add product and user to cart
    - if user have cart find index of this product in cart items
    - if product exist add product quantity +1
    - if product doesn't exist in cart items push it to cart items
3- calc total price
4- save cart
*/
...
/*calculate total price in all function
